...
ggplot(departmentSickTime) +
  ...
  labs(
    y = "Sick Time  [hours]",
    title = "Total Yearly Sick Time Totals as of 28-Aug-2021"
  )
```
...
ggplot(yearlySickTime) +
  ...
  labs(
    y = "Sick Time  [hours]",
    title = "Yearly Sick Time Totals as of 28-Aug-2021"
  ) +
...
ggplot(monthlySickTime) +
  ...
  labs(
    y = "Sick Time  [hours]",
    title = "Monthly Sick Time Totals per Year as of 28-Aug-2021"
  ) +
  facet_wrap(~ Name, nrow = 4)
```
...
ggplot(monthlyVacationTime) +
  ...
  labs(
    ...
    title = "Monthly Vacation Time Totals per Year as of 28-Aug-2021"
  ) +
  facet_wrap(~ Name, nrow = 4)
